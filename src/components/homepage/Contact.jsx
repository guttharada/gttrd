    ...
    >
      ...
      >
        <div className="col-span-4">
          ...
          >
            I am now open for freelance work and accepting new projects
            immediately.{" "}
          </p>
          <form
            name="contact"
            ...
            >
              <span className="relative">
                ...
                <span className="group-hover:text-accent-400">
                  <a
                    href="mailto:guttharada.developer@gmail.com"
        ...
        <div className="col-span-2 grid grid-cols-1 gap-x-4 gap-y-8 text-accent-300 sm:grid-cols-2 sm:gap-y-0 md:grid-cols-1">
          <div className="space-y-3 ">
            ...
            <div className="flex flex-col space-y-3 text-body-2 2xl:text-3xl">
              <a
                ...
                rel="noreferrer"
              >
                <span>guttharada.developer@gmail.com</span>
          ...
          <div className="space-y-3 ">
            ...
            <div className="space-y-3 text-body-2 2xl:text-3xl">
              ...
              <a
                href="https://github.com/guttharada"
                className="group flex items-center space-x-2"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                href="https://www.linkedin.com/in/gttrd/"
